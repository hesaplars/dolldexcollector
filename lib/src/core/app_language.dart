...
const _tr = {
  ...
  'ageRequirement':
      'DollDex Collector kullanmak için en az 14 yaşında olmalısın.',
  'ageTooYoung': '13 yaş ve altındaki kullanıcıların kayıt yapmasına izin verilmemektedir.',
...
const _en = {
  ...
  'ageRequirement':
      'You must be at least 14 years old to use DollDex Collector.',
  'ageTooYoung':
      'Registration is not permitted for users aged 13 and under.',
